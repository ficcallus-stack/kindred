...
export default function AdminShell({ children, adminName, adminInitial }: AdminShellProps) {
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-4 pl-2">
              <div className="text-right">
                <p className="text-[15px] font-black text-[#002B5B] leading-tight tracking-tight">{adminName}</p>
