...
export const metadata: Metadata = {
  title: "Job Details | KindredCare Marketplace",
      ...
      <div className="bg-surface min-h-screen flex flex-col">
        <main className="flex-1 flex flex-col items-center justify-center p-6 text-center pt-32">
          ...
          <p className="text-lg text-on-surface-variant max-w-lg mx-auto mb-10 leading-relaxed">
            Private family details are only accessible to <strong>Verified Caregivers</strong>. Please complete your identity verification to unlock full job details and start applications.
          </p>
          {!user ? (
