...
const VERIFICATION_STEPS = [
  {
    ...
    status: "Verified",
    description: "Official ID and live photo comparison performed via Stripe Identity.",
    icon: "badge",
  ...
  },
  {
    ...
    status: "Cleared",
    description: "National criminal record and sex offender registry scan completed.",
    icon: "security",
  ...
  },
  {
    ...
    status: "In Progress",
    description: "Automated scan of public social profiles and professional history.",
    icon: "language",
  ...
  },
  {
    ...
    status: "Requested",
    description: "Comprehensive review of your home environment for childcare safety.",
    icon: "home_health",
    bg: "bg-primary-fixed",
...
export default function VerificationPage() {
  return (
    <div className="p-8 lg:p-12 animate-in fade-in duration-700 max-w-6xl mx-auto space-y-12">
      ...
      <header className="relative overflow-hidden rounded-[3rem] bg-surface-container-low border border-outline-variant/10 p-12 md:p-16 text-primary shadow-2xl shadow-primary/5 group">
        <div className="relative z-10 max-w-2xl space-y-8">
          ...
          <div className="flex flex-col sm:flex-row gap-6 pt-4">
            ...
            <div className="flex items-center gap-4 px-2">
              ...
              <span className="text-on-surface-variant font-black uppercase tracking-widest text-[10px] opacity-40">Scan in progress...</span>
            </div>
          </div>
        </div>
        ...
        <div className="absolute top-12 right-12 bg-white/80 backdrop-blur-xl p-8 rounded-[2.5rem] shadow-2xl flex items-center gap-6 z-20 max-w-xs border border-white/50 animate-bounce-slow">
          ...
          <div className="min-w-0">
            <p className="font-black text-primary leading-tight text-lg tracking-tight truncate">95% Trust Rating</p>
            <p className="text-[10px] font-black uppercase tracking-widest text-on-surface-variant opacity-40">Top 5% of families</p>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-6 gap-8">
          {VERIFICATION_STEPS.map(step => (
            ...
            >
              ...
              {step.action && (
                <button className="mt-8 w-full py-4 bg-primary text-white rounded-2xl font-black uppercase tracking-widest text-[10px] shadow-xl shadow-primary/20 hover:shadow-primary/40 transition-all">
                  {step.action}
                </button>
              )}
            </div>
          ...
          <div className="md:col-span-6 bg-surface-container-lowest p-12 rounded-[3.5rem] shadow-sm flex flex-col md:flex-row justify-between items-center gap-16 overflow-hidden relative group hover:shadow-2xl transition-all border border-outline-variant/5">
            ...
            <div className="max-w-2xl relative z-10 space-y-8">
              ...
              <div className="flex flex-wrap gap-4">
                {["AES-256 Encryption", "GDPR Compliant", "PCI-DSS Level 1"].map(tag => (
