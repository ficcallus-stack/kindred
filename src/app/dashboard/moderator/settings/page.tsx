  ...
  return (
    <div className="max-w-3xl mx-auto space-y-8">
      <div>
        ...
        <p className="text-on-surface-variant font-medium mt-1">Manage your account preferences and security.</p>
      </div>
      ...
      <div className="bg-surface-container-lowest p-8 rounded-3xl shadow-sm border border-outline-variant/10 space-y-8">
        ...
        <div className="flex items-start gap-6">
          <div className="w-20 h-20 rounded-2xl bg-primary/10 flex items-center justify-center border border-primary/20 shrink-0">
            {user?.photoURL ? (
              ...
              <MaterialIcon name="shield_person" className="text-4xl text-primary" />
            )}
          </div>
          <div className="space-y-1">
            <h2 className="font-headline text-2xl font-bold text-primary">{user?.displayName || "Moderator Account"}</h2>
        ...
        <div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between p-4 bg-surface rounded-2xl border border-outline-variant/10">
              <div>
                <p className="font-bold text-sm text-primary">Role & Permissions</p>
                <p className="text-sm text-on-surface-variant">Full moderation access</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="bg-error-container/20 p-6 rounded-2xl border border-error/20 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
              ...
              <p className="text-sm text-error/80 mt-1">Sign out of your moderator account on this device.</p>
            </div>
            <button
              onClick={signOut}
